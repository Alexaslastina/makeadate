...
let ReviewsController = class ReviewsController {
    ...
    create(dateId, body) {
        return this.s.create({ ...body, dateId });
    }
    list(dateId, q) {
        return this.s.listByDate(dateId, q.page, q.limit);
    }
    summary(dateId) {
        return this.s.getSummary(dateId);
    }
    // מחיקה בסיסית (ללא הרשאות מתקדמות)
    remove(reviewId) {
        return this.s.delete(reviewId);
    }
};
...
exports.ReviewsController = ReviewsController = __decorate([
    (0, common_1.Controller)('dates/:dateId/reviews'),
